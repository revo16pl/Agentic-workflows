...
1. Source of truth
- Lokalny Markdown w repo (`runtime/agentic-articles/workspace/...`) jako audytowalna historia zmian.
...
- `/archive/do-usuniecia/generated-artifacts/Agentic_Articles_legacy/`
