...
```bash
python3 workflows/content-planning/scripts/content_planning_autopilot.py \
...
```bash
python3 workflows/content-planning/scripts/content_planning_init.py --sprint-date 2026-03-15 --companies "studio balans,druga firma"
python3 workflows/content-planning/scripts/content_planning_ingest.py --sprint "runtime/agentic-articles/planning/2026-03-15_sprint"
python3 workflows/content-planning/scripts/content_planning_cluster.py --sprint "runtime/agentic-articles/planning/2026-03-15_sprint"
python3 workflows/content-planning/scripts/content_planning_gate.py --sprint "runtime/agentic-articles/planning/2026-03-15_sprint"
python3 workflows/content-planning/scripts/content_planning_to_queue.py --sprint "runtime/agentic-articles/planning/2026-03-15_sprint"
```
