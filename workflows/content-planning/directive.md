...
# 1) Init sprint
python3 workflows/content-planning/scripts/content_planning_init.py \
  --sprint-date 2026-03-15 \
  --companies "studio balans,druga firma"

# 2) Copy manual exports to:
# runtime/agentic-articles/planning/2026-03-15_sprint/research_inputs/

# 3) Ingest
python3 workflows/content-planning/scripts/content_planning_ingest.py \
  --sprint "runtime/agentic-articles/planning/2026-03-15_sprint"

# 4) Cluster + score
python3 workflows/content-planning/scripts/content_planning_cluster.py \
  --sprint "runtime/agentic-articles/planning/2026-03-15_sprint"

# 5) Evaluate strict gate
python3 workflows/content-planning/scripts/content_planning_gate.py \
  --sprint "runtime/agentic-articles/planning/2026-03-15_sprint"

# 6) Publish queue (only if planning_hard_block_pass=PASS)
python3 workflows/content-planning/scripts/content_planning_to_queue.py \
  --sprint "runtime/agentic-articles/planning/2026-03-15_sprint"
