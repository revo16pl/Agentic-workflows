...
def write_iteration_feedback(workspace: Path, errors: list[str]) -> Path:
    ...
    error_map = {
        ...
        "polish language auto-fix/check failed": "Uruchom `workflows/agentic-articles/scripts/check_polish_language.py --apply` i popraw wskazane problemy przed eksportem.",
        "humanization check failed": "Uruchom `workflows/agentic-articles/scripts/check_humanization.py`, popraw tekst i doprowadz wszystkie humanization gates do PASS.",
        "polish naturalness check failed": "Uruchom `workflows/agentic-articles/scripts/check_polish_naturalness.py`, popraw tytuł/kolokacje/rytm i powtórz walidację.",
        "polish fluency ml check failed": "Uruchom `workflows/agentic-articles/scripts/check_polish_fluency_ml.py` i popraw fragmenty o niskiej płynności językowej.",
        ...
        "research quality check failed": "Uruchom `workflows/agentic-articles/scripts/check_research_quality.py`, popraw dane research i doprowadź wszystkie research gates do PASS.",
        ...
        "keyword_metrics_coverage_pass": "Uruchom `workflows/agentic-articles/scripts/research_fetch.py` i upewnij się, że manifest ma min. 40 rekordów `keyword_metrics` oraz >=80% z `avg_monthly_searches`.",
        "serp_dataset_quality_pass": "Uzupełnij dane SERP (min. 30 rekordów i min. 8 unikalnych domen) przez `workflows/agentic-articles/scripts/research_fetch.py`.",
        "trends_dataset_quality_pass": "Uzupełnij dane trends (min. 5 zapytań i min. 12 punktów na zapytanie) przez `workflows/agentic-articles/scripts/research_fetch.py`.",
        "competitor_matrix_pass": "Uzupełnij `competitor_matrix` (min. 10 URL) i `content_gaps` (min. 5).",
        "research_data_freshness_pass": "Odśwież research (`workflows/agentic-articles/scripts/research_fetch.py`), aby `pulled_at` było aktualne.",
        "research_hard_block_pass": "Uruchom `workflows/agentic-articles/scripts/check_research_quality.py` i doprowadź wszystkie research gate'y do PASS.",
        "topic_from_approved_plan_pass": "Uruchom artykuł z `workflows/agentic-articles/scripts/prepare_article_from_queue.py` na rekordzie `RUN_QUEUE` z `workflow_b_ready=yes` i statusem approved.",
    }
