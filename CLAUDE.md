...
If the user asks about skills in any form (usage, discovery, installation, setup, identification, search, or operational workflow), read `SKILL_SETUP.md` first and follow it as the source of truth for how skills should be found, installed, set up, and used.
