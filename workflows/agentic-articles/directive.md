...
## Execution Scripts
- `workflows/agentic-articles/scripts/article_workflow_init.py`
- `workflows/agentic-articles/scripts/prepare_article_from_queue.py`
- `workflows/agentic-articles/scripts/prepare_service_page_from_url.py`
- `workflows/agentic-articles/scripts/company_profile_resolver.py`
- `workflows/agentic-articles/scripts/extract_service_page_context.py`
- `workflows/agentic-articles/scripts/research_fetch.py`
- `workflows/agentic-articles/scripts/check_research_quality.py`
- `workflows/agentic-articles/scripts/article_workflow_validate.py`
- `workflows/agentic-articles/scripts/check_polish_language.py`
- `workflows/agentic-articles/scripts/check_polish_naturalness.py`
- `workflows/agentic-articles/scripts/check_polish_fluency_ml.py`
- `workflows/agentic-articles/scripts/check_humanization.py`
- `workflows/agentic-articles/scripts/check_workflow_context.py`
- `workflows/agentic-articles/scripts/export_to_gdocs.py`
...
- `skills_policy_pass` requires both:
  ...
  - consistent declaration and use in the Codex run context
...
python3 workflows/agentic-articles/scripts/prepare_article_from_queue.py \
  --queue-row-id "rq-0001"

# 2) Fill artifacts manually/agentically in workspace
# runtime/agentic-articles/workspace/YYYY-MM-DD_topic-slug/

# 3) Run data-driven research fetch and research quality gates
python3 workflows/agentic-articles/scripts/research_fetch.py \
  --workspace "runtime/agentic-articles/workspace/YYYY-MM-DD_topic-slug"

python3 workflows/agentic-articles/scripts/check_research_quality.py \
  --workspace "runtime/agentic-articles/workspace/YYYY-MM-DD_topic-slug"

# 4) Run language/naturalness/ML/humanization/context checks
python3 workflows/agentic-articles/scripts/check_polish_language.py \
  --workspace "runtime/agentic-articles/workspace/YYYY-MM-DD_topic-slug" \
  --apply

python3 workflows/agentic-articles/scripts/check_polish_naturalness.py \
  --workspace "runtime/agentic-articles/workspace/YYYY-MM-DD_topic-slug"

python3 workflows/agentic-articles/scripts/check_polish_fluency_ml.py \
  --workspace "runtime/agentic-articles/workspace/YYYY-MM-DD_topic-slug"

python3 workflows/agentic-articles/scripts/check_humanization.py \
  --workspace "runtime/agentic-articles/workspace/YYYY-MM-DD_topic-slug"

python3 workflows/agentic-articles/scripts/check_workflow_context.py \
  --workspace "runtime/agentic-articles/workspace/YYYY-MM-DD_topic-slug"

# 5) Validate final gates before export
python3 workflows/agentic-articles/scripts/article_workflow_validate.py \
  --workspace "runtime/agentic-articles/workspace/YYYY-MM-DD_topic-slug" \
  --mode pre_export \
...
python3 workflows/agentic-articles/scripts/export_to_gdocs.py \
  --workspace "runtime/agentic-articles/workspace/YYYY-MM-DD_topic-slug" \
  --content-profile article \
  --export-mode prod
...
python3 workflows/agentic-articles/scripts/prepare_service_page_from_url.py \
...
# python3 workflows/agentic-articles/scripts/export_to_gdocs.py ... --export-mode debug --skip-validation
```
